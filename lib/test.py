...
if cfg.data_name == 'data_300W' or cfg.data_name == 'data_300W_COFW_WFLW' or cfg.data_name == 'data_300W_CELEBA':
    ...
    norm_indices = [8, 9]
elif cfg.data_name == 'WFLW' or cfg.data_name == 'WFLW_dvs_v3' or cfg.data_name == 'WFLW_dvs_v3_SS':
    norm_indices = [60, 72]
...
for label in labels:
    image_name = label[0]
    lms_gt = label[1]
    if cfg.data_name == 'data_300W' or cfg.data_name == 'COFW' or cfg.data_name == 'WFLW' or \
            cfg.data_name == 'data_300W_COFW_WFLW' or cfg.data_name == 'data_300W_CELEBA' or cfg.data_name == 'WFLW_dvs_v3' or cfg.data_name == 'WFLW_dvs_v3_SS':
